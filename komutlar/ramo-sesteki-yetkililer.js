...
if(!["792869686416506911", "792869685104345108"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
//-------------------------------------------------------------------------------\\
  ...
  message.guild.roles.cache.get("792869685104345108").members.map(r => {
