...
client.on("ready", () => {
  client.channels.cache.get('793768029544644608').join();
})
...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const tag = '༮'
  const sunucu = '792869074836258846'
  const kanal = '792869787294236673'
  const rol = '792869705227960330'
...
client.on("message", message => {
    ...
    return message.channel.send(`Arellanın Vazgeçilmezi`)
});
...
client.on("message", message => {
    if(message.content.toLowerCase() == "Alwen") 
    return message.channel.send(`Alwen adamdır :heart: :heart:`)
});
...
db.delete(`cezali_${member.guild.id + member.id}`)
    ...
    member.roles.remove('788083262508498964');
  }, ms(sürejail));
}
})
...
db.delete(`muteli_${member.guild.id + member.id}`)
    ...
    member.roles.remove('788083221152923649');
  }, ms(süre));
}
})
